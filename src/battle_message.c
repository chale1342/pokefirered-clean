...
static const u8 sText_PkmnInCaptureEXP[] = _("Gained {B_BUFF1} EXP. Points\nfor catching a POKéMON!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_PKMNINCAPTUREEXP - BATTLESTRINGS_TABLE_START]              = sText_PkmnInCaptureEXP,
