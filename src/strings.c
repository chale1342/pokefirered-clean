...
const u8 gText_ExpShareOff[] = _("Turned off the EXP. SHARE.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOn[] = _("Turned on the EXP. SHARE.{PAUSE_UNTIL_PRESS}");
const u8 gText_AutoRun[] = _("AUTO RUN");
const u8 gText_AutoRunOff[] = _("OFF");
const u8 gText_AutoRunOn[] = _("ON");
